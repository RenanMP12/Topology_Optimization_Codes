...
% @module: METODOS DE OTIMIZACAO TOPOLOGICA EVOLUCIONARIA 
%
...
nx = 101; % nodes number in x
ny = 21; % nodes number in y
Lx = 5; % length in x [m]
Ly = 1; % length in y [m]
...
plot(count,frequency_2,'-xb');

frequency_3 = frequency(count,3);
plot(count,frequency_3,'-sk');
