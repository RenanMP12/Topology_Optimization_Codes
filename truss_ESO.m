...
% METODOS DE OTIMIZACAO TOPOLOGICA EVOLUCIONARIA 
%
...
for i = 1:nel 
        ...
        Nfun=4; % number of nodes for each element
        ke=zeros(2*Nfun); % local stiffness matrix pre-allocation
        Bs=zeros(3,2*Nfun); % deformation matrix pre-allocation
...
figure('Name','Truss - ESO','NumberTitle','off');
...
figure('Name','Stresses plot','NumberTitle','off');
hold on
